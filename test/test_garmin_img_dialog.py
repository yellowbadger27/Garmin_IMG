...
from garmin_img_dialog import GarminIMGDialog
...
class GarminIMGDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = GarminIMGDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(GarminIMGDialogTest)
