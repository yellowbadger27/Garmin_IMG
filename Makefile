...
SOURCES = \
	__init__.py \
	garmin_img.py garmin_img_dialog.py

PLUGINNAME = garmin_img

PY_FILES = \
	__init__.py \
	garmin_img.py garmin_img_dialog.py

UI_FILES = garmin_img_dialog_base.ui
...
QGISDIR=C:\Users\Utilisateur\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
